...
tape('nil envelope', function (t) {
  ...
  const classicNull = convertNilForEnvelopeSpec(bfe.encode(null), bfe.encode(classicFeed))
  ...
  const classicMsg = convertNilForEnvelopeSpec(bfe.encode(msg), bfe.encode(classicFeed))
